...
draw_route(file_name, 'KIZON1L', convert.to_gr(points.KIZON), convert.to_gr(rnav_points.NN015), convert.to_gr(rnav_points.NN003))
draw_route(file_name, 'NOKDA1L', convert.to_gr(points.NOKDA), convert.to_gr(rnav_points.NN015), convert.to_gr(rnav_points.NN003))
draw_route(file_name, 'GIGOR1L', convert.to_gr(points.GIGOR), convert.to_gr(rnav_points.NN003))
draw_route(file_name, 'OSBET1L', convert.to_gr(points.OSBET), convert.to_gr(rnav_points.NN016), convert.to_gr(rnav_points.NN001))
draw_route(file_name, 'LIRSA1L', convert.to_gr(points.LIRSA), convert.to_gr(rnav_points.NN016), convert.to_gr(rnav_points.NN001))
