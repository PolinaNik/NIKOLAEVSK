...
draw_route_tr(file_name, 'RATNU1K_11', convert.to_gr(points.RATNU), convert.to_gr(points.VOR_DME),
           right_turn1.first_turn(), convert.to_gr(kinks.kink_left_down), right_turn2.first_turn(),
           convert.to_gr(start_point))

draw_route_tr(file_name, 'PIKUS1K_11', convert.to_gr(points.PIKUS), convert.to_gr(start_point))

draw_route_tr(file_name, 'TEBSA1K_11', convert.to_gr(points.TEBSA), convert.to_gr(points.VOR_DME),
           right_turn1.first_turn(), convert.to_gr(kinks.kink_left_down), right_turn2.first_turn(),
           convert.to_gr(start_point))

draw_route_tr(file_name, 'TOTRU1K_11', convert.to_gr(points.TOTRU), convert.to_gr(points.VOR_DME), hippo2.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name, 'DOKIR1K_11', convert.to_gr(points.DOKIR), convert.to_gr(points.VOR_DME), hippo2.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name, 'KIZON1K_11', convert.to_gr(points.KIZON), convert.to_gr(points.VOR_DME), hippo2.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name, 'NOKDA1K_11', convert.to_gr(points.NOKDA), convert.to_gr(points.VOR_DME), hippo2.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name, 'GIGOR1K_11', convert.to_gr(points.GIGOR), convert.to_gr(points.VOR_DME), hippo2.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name, 'OSBET1K_11', convert.to_gr(points.OSBET), convert.to_gr(points.VOR_DME), hippo1.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name, 'LIRSA1K_11', convert.to_gr(points.LIRSA), convert.to_gr(points.VOR_DME), hippo1.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name, 'LEKBI1K_11', convert.to_gr(points.LEKBI), convert.to_gr(points.VOR_DME), hippo1.first_turn(),
           right_turn1.first_turn(), right_turn2.first_turn(), convert.to_gr(start_point))
