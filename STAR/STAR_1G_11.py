...
file_name_tr = 'uhnn_star(1g_11)_tr'
...
draw_route_tr(file_name_tr, 'RATNU1G_11', convert.to_gr(points.RATNU), convert.to_gr(kinks.ratnu_kink),
           convert.to_gr(points.VOR_DME), right_turn1.first_turn(),
           convert.to_gr(kinks.kink_left_down), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'PIKUS1G_11', convert.to_gr(points.PIKUS), convert.to_gr(kinks.pikus_kink),
           convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'TEBSA1G_11', convert.to_gr(points.TEBSA), convert.to_gr(kinks.tebsa_kink),
           convert.to_gr(points.VOR_DME), right_turn1.first_turn(),
           convert.to_gr(kinks.kink_left_down), right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'TOTRU1G_11', convert.to_gr(points.TOTRU), convert.to_gr(kinks.totru_kink),
           convert.to_gr(points.VOR_DME), hippo2.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'DOKIR1G_11', convert.to_gr(points.DOKIR), convert.to_gr(kinks.dokir_kink),
           convert.to_gr(points.VOR_DME), hippo2.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'KIZON1G_11', convert.to_gr(points.KIZON), convert.to_gr(kinks.kizon_kink),
           convert.to_gr(points.VOR_DME), hippo2.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'NOKDA1G_11', convert.to_gr(points.NOKDA), convert.to_gr(kinks.nokda_kink),
           convert.to_gr(points.VOR_DME), hippo2.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'GIGOR1G_11', convert.to_gr(points.GIGOR), convert.to_gr(kinks.gigor_kink),
           convert.to_gr(points.VOR_DME), hippo2.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'OSBET1G_11', convert.to_gr(points.OSBET), convert.to_gr(kinks.osbet_kink),
           convert.to_gr(points.VOR_DME), hippo1.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'LIRSA1G_11', convert.to_gr(points.LIRSA),
           convert.to_gr(points.VOR_DME), hippo1.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'LEKBI1G_11', convert.to_gr(points.LEKBI), convert.to_gr(kinks.lekbi_kink),
           convert.to_gr(points.VOR_DME), hippo1.first_turn(), right_turn1.first_turn(),
           right_turn2.first_turn(), convert.to_gr(start_point))
