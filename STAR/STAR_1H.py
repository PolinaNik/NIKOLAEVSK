...
draw_route_tr(file_name_tr, 'RATNU1H', convert.to_gr(points.RATNU), convert.to_gr(points.LOM),
           hippo1.first_turn(), left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'PIKUS1H', convert.to_gr(points.PIKUS), convert.to_gr(points.LOM),
           hippo1.first_turn(), left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'TEBSA1H', convert.to_gr(points.TEBSA), convert.to_gr(points.LOM),
           hippo2.first_turn(), left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'TOTRU1H', convert.to_gr(points.TOTRU), convert.to_gr(points.LOM),
           hippo2.first_turn(), left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'DOKIR1H', convert.to_gr(points.DOKIR), convert.to_gr(points.LOM),
           left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'KIZON1H', convert.to_gr(points.KIZON), convert.to_gr(points.LOM),
           left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'NOKDA1H', convert.to_gr(points.NOKDA), convert.to_gr(points.LOM),
           left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'GIGOR1H', convert.to_gr(points.GIGOR), convert.to_gr(points.LOM),
           left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'OSBET1H', convert.to_gr(points.OSBET), convert.to_gr(points.LOM),
           hippo1.first_turn(), left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'LIRSA1H', convert.to_gr(points.LIRSA), convert.to_gr(points.LOM),
           hippo1.first_turn(), left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))

draw_route_tr(file_name_tr, 'LEKBI1H', convert.to_gr(points.LEKBI), convert.to_gr(points.LOM),
           hippo1.first_turn(), left_turn2.first_turn(), left_turn1.first_turn(), convert.to_gr(start_point))
