...
TEBSA = RoundRoute(start_point=start_point, start_bearing=108,
              begin_arc=begin_arc, turn1='RIGHT', glob_center=gl_center_down, glob_rad=gl_rad_down, kink=points.VOR_DME,
...
LEKBI = ParalelRoute(start_point=start_point, start_bearing=108,
              begin_arc=begin_arc, turn1='RIGHT', glob_center=gl_center_down, glob_rad=gl_rad_down, kink=kinks.lekbi,
...
draw_route(file_name, 'TEBSA1B', convert.to_gr(start_point), convert.to_gr(begin_arc), TEBSA.first_turn(), convert.to_gr(points.LOM),
           TEBSA.glob_round(), TEBSA.second_turn(), convert.to_gr(points.TEBSA))

draw_route(file_name, 'TOTRU1B', convert.to_gr(start_point), convert.to_gr(begin_arc), TOTRU.first_turn(), convert.to_gr(kinks.totru),
           TOTRU.second_turn(), convert.to_gr(points.TOTRU))

draw_route(file_name, 'DOKIR1B', convert.to_gr(start_point), convert.to_gr(begin_arc), DOKIR.first_turn(), convert.to_gr(kinks.dokir),
           DOKIR.second_turn(), convert.to_gr(points.DOKIR))

draw_route(file_name, 'KIZON1B', convert.to_gr(start_point), convert.to_gr(begin_arc), KIZON.first_turn(), convert.to_gr(kinks.kizon),
           KIZON.second_turn(), convert.to_gr(points.KIZON))

draw_route(file_name, 'NOKDA1B', convert.to_gr(start_point), convert.to_gr(begin_arc), NOKDA.first_turn(), convert.to_gr(kinks.nokda),
           NOKDA.second_turn(), convert.to_gr(points.NOKDA))

draw_route(file_name, 'GIGOR1B', convert.to_gr(start_point), convert.to_gr(begin_arc), GIGOR.first_turn(), convert.to_gr(kinks.gigor),
           GIGOR.second_turn(), convert.to_gr(points.GIGOR))

draw_route(file_name, 'OSBET1B', convert.to_gr(start_point), convert.to_gr(begin_arc), OSBET.first_turn(), convert.to_gr(kinks.osbet),
           OSBET.second_turn(), convert.to_gr(points.OSBET))

draw_route(file_name, 'LIRSA1B', convert.to_gr(start_point), convert.to_gr(begin_arc), LIRSA.first_turn(), convert.to_gr(kinks.lirsa),
           LIRSA.second_turn(), convert.to_gr(points.LIRSA))

draw_route(file_name, 'LEKBI1B', convert.to_gr(start_point), convert.to_gr(begin_arc), LEKBI.first_turn(), convert.to_gr(kinks.lekbi),
           LEKBI.second_turn(), convert.to_gr(points.LEKBI))

draw_route(file_name, 'RATNU1B', convert.to_gr(start_point), convert.to_gr(begin_arc), RATNU.first_turn(), convert.to_gr(points.LOM),
           RATNU.glob_round(), RATNU.second_turn(), convert.to_gr(points.RATNU))

draw_route(file_name, 'PIKUS1B', convert.to_gr(start_point), convert.to_gr(begin_arc), PIKUS.first_turn(), convert.to_gr(points.LOM),
