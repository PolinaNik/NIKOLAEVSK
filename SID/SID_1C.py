...
draw_route(file_name, 'TEBSA1C', convert.to_gr(start_point), convert.to_gr(begin_arc), TEBSA.first_turn(), convert.to_gr(kinks.tebsa),
           TEBSA.second_turn(), convert.to_gr(points.TEBSA))

draw_route(file_name, 'TOTRU1C', convert.to_gr(start_point), convert.to_gr(begin_arc), TOTRU.first_turn(), convert.to_gr(kinks.totru),
           TOTRU.second_turn(), convert.to_gr(points.TOTRU))

draw_route(file_name, 'DOKIR1C', convert.to_gr(start_point), convert.to_gr(begin_arc), DOKIR.first_round(), convert.to_gr(points.LOM),
           DOKIR.glob_round(), DOKIR.second_turn(), convert.to_gr(points.DOKIR))

draw_route(file_name, 'KIZON1C', convert.to_gr(start_point), convert.to_gr(begin_arc), KIZON.first_round(), convert.to_gr(points.LOM),
           convert.to_gr(points.KIZON))

draw_route(file_name, 'NOKDA1C', convert.to_gr(start_point), convert.to_gr(begin_arc), NOKDA.first_round(), convert.to_gr(points.LOM),
           convert.to_gr(points.NOKDA))

draw_route(file_name, 'GIGOR1C', convert.to_gr(start_point), convert.to_gr(begin_arc), GIGOR.first_round(), convert.to_gr(points.LOM),
           convert.to_gr(points.GIGOR))

draw_route(file_name, 'OSBET1C', convert.to_gr(start_point), convert.to_gr(begin_arc), OSBET.first_round(), convert.to_gr(points.LOM),
           convert.to_gr(points.OSBET))

draw_route(file_name, 'LIRSA1C', convert.to_gr(start_point), convert.to_gr(begin_arc), LIRSA.first_round(), convert.to_gr(points.LOM),
           LIRSA.glob_round(), LIRSA.second_turn(), convert.to_gr(points.LIRSA))

draw_route(file_name, 'LEKBI1C', convert.to_gr(start_point), convert.to_gr(begin_arc), LEKBI.first_turn(), convert.to_gr(kinks.lekbi),
           LEKBI.second_turn(), convert.to_gr(points.LEKBI))

draw_route(file_name, 'RATNU1C', convert.to_gr(start_point), convert.to_gr(begin_arc), RATNU.first_turn(), convert.to_gr(kinks.ratnu),
           RATNU.second_turn(), convert.to_gr(points.RATNU))

draw_route(file_name, 'PIKUS1C', convert.to_gr(start_point), convert.to_gr(begin_arc), PIKUS.first_turn(), convert.to_gr(kinks.pikus),
